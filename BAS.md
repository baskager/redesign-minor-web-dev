...
I have introduced the MOSCOW methodology to the team because I have used it in projects before and I have allways found it usefull to have a list of priorities.
...
Now that we had our cards divided into pages. I offered to make a diagram for the database. I've kept this diagram simple and combined a class diagram with an ERD diagram for ease of reading.

This diagram made clear how the data would be represented. This later turned out very usefull for the wireframs as we already had a general idea of what data should be on what page.
...
I've drawn up some elements displayed on the images below.
